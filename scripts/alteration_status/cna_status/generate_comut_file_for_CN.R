...
load("tRCC_test_run_optimals_geneMats.RData") #1=LOH and 0=notLOH
...
ploidy <- read.csv("../../../metadata/sampleList_optimals.csv")[,c("sample","category","value")]
...
write.csv(out_alteration_all, sprintf("comut_CN_tRCC_test_run_optimals.csv", cp_threshold), quote=F)
